...
- `B-05` : implemente pour le socle actuel. Le backend refuse un `JWT_SECRET` absent/faible en `LORE_ENV=production`, rate-limit l'emission de tokens, et le login web applique un lockout IP+email.
